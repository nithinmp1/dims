...
class Staff extends CI_Controller
{
    ...
    {
        if ($this->session->userdata('staff_login') != 1)
            redissrect(base_url(), 'refresh');
        
        $page_data = [
                'page_name' => 'staff_dashboard',
                'page_title' => get_phrase('admin_dashboard')
            ];
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?staff/student_payment', 'refresh');
        }
        ...
        if ($param1 == 'do_update') {
            ...
            redirect(base_url() . 'index.php?staff/income', 'refresh');
        } else if ($param1 == 'edit') {
    ...
    function expense($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->db->insert('payment' , $data);
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?staff/expense', 'refresh');
        }
    ...
    function expense_category($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?staff/expense_category');
        }
        if ($param1 == 'edit') {
            $data['name']   =   $this->input->post('name');
