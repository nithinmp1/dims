	...
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?instructor/attendance_selector" class="form">
            	<tr class="gradeA">
                    <td>
			...
			foreach($students as $row)
			{
				...
				<tr class="gradeA">
					...
					<td align="center">
                        ...
                        <form method="post" action="<?php echo base_url();?>index.php?instructor/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
