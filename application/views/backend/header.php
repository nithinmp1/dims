<div class="row">
	...
	<div class="col-md-12 col-sm-12 clearfix ">
		...
		<li class="dropdown language-selector">
                    <a href="#" class="dropdown-toggle notification" data-toggle="dropdown" data-close-others="true">
                        	<i class="entypo-user"></i> <?php echo $this->session->userdata('login_type');?>
                        		<?php if($this->crud_model->messageCount() > 0){ ?>
							  <span class="badge" onclick='window.open("<?php echo base_url(); ?>index.php?admin/message", "message");'><?=$this->crud_model->messageCount();?></span>
								<?php } ?>
                    </a>

				<?php if ($account_type != 'parent'):?>
				<ul class="dropdown-menu <?php if ($text_align == 'right-to-left') echo 'pull-right'; else echo 'pull-left';?>">
					<?php $this->load->view('backend/admin/quicklinks'); ?>
					<li>
