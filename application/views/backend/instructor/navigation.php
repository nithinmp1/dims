<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="main-menu">
        ...
        <!-- CLOCKIN -->
        <li class="<?php if ($page_name == 'clockin') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/clockin">
                <i class="entypo-clock"></i>
                <span><?php echo get_phrase('clockin'); ?></span>
            </a>
            <ul>
                <?php
                 $classes = $this->db->get_where('class',['instructor_id' => $this->session->userdata('instructor_id')])->result_array();
                 foreach ($classes as $row):
                ?>
                    <li class="<?php if ($page_name == $row['name'].'_clockin' && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/clockin/<?php echo $row['class_id']; ?>">
                            <span><?php echo get_phrase('class'); ?> <?php echo  $row['name'].'_clockin'; ?></span>
                        </a>
                    </li>
                <?php endforeach; ?>
            </ul>
        ...
        <li class="<?php if ($page_name == 'instructor') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/instructor_list">
            ...
            <ul>
                ...
                foreach ($classes as $row):
                    ...
                    <li class="<?php if ($page_name == 'class_routine' && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a href="<?php echo base_url(); ?>index.php?instructor/class_routine/<?php echo $row['class_id']; ?>">
                            <span><?php echo get_phrase('class'); ?> <?php echo $row['name']; ?></span>
                        </a>
                    </li>
                <?php endforeach; ?>
        ...
        <li class="<?php if ($page_name == 'academic_syllabus') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?instructor/academic_syllabus">
        ...
        <li class="<?php if ($page_name == 'marks_manage' || $page_name == 'marks_manage_view' || $page_name == 'question_paper') echo 'opened active';?> ">
            ...
            <ul>
                <li class="<?php if ($page_name == 'marks_manage' || $page_name == 'marks_manage_view') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?instructor/marks_manage">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('manage_marks'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'question_paper') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?instructor/question_paper">
            ...
            <ul>
                ...
                foreach ($classes as $row):
                    ...
                    <li class="<?php if (($page_name == 'manage_attendance' || $page_name == 'manage_attendance_view') && $class_id == $row['class_id']) echo 'active'; ?>">
                        <a href="<?php echo base_url(); ?>index.php?instructor/manage_attendance/<?php echo $row['class_id']; ?>">
                            <span><?php echo get_phrase('class'); ?> <?php echo $row['name']; ?></span>
                        </a>
                    </li>
                <?php endforeach; ?>
