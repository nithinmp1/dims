...
<table class="table table-bordered table-striped datatable" id="table_export">
    ...
    <tbody>
        ...
        $question_papers = $this->db->get_where('question_paper', array('instructor_id' => $this->session->userdata('login_user_id')))->result_array();
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                            ...
                            <li>
                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?instructor/question_paper/delete/<?php echo $row['question_paper_id']; ?>');">
