...
<div class="row">
	...
	<?php
		...
		$section_idArr = array_column($instructor_attendance,'section_id');		
		$this->db->where_in('section_id',$section_idArr);
...
<div class="row">
	...
	<?php echo form_open(base_url() . 'index.php?instructor/attendance_update/'.$class_id.'/'.$section_id.'/'.$timestamp);?>
