<hr />
<?php echo form_open(base_url() . 'index.php?instructor/marks_selector');?>
<div class="row">
...
<div class="row">
	...
	<div class="col-md-8">
		...
		<?php echo form_open(base_url() . 'index.php?instructor/marks_update/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id);?>
...
<script type="text/javascript">
	function get_class_subject(class_id) {
		...
		$.ajax({
            url: '<?php echo base_url();?>index.php?instructor/marks_get_subject/' + class_id ,
