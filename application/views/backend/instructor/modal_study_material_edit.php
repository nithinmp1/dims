        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?instructor/study_material/update/<?php echo $row['document_id'] ?>" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function get_class_subject(class_id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>index.php?instructor/get_class_subject/' + class_id,
