...
<?php echo form_open(base_url() . 'index.php?admin/attendance_selector_instructor/'); ?>
<div class="row">
    <div class="col-md-3">
    ...
    <div class="col-md-3" style="margin-top: 20px;">
        <button type="submit" class="btn btn-info"><?php echo get_phrase('manage_instructors_attendance'); ?></button>
    </div>
...
<!--            <h3 style="color: #696969;"><?php echo get_phrase('attendance_for_class'); ?> <?php echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name; ?></h3>
            ...
            <h2>Attendance For instructors </h2>
...
<div class="row">
    ...
    <div class="col-md-8">
        <?php echo form_open(base_url() . 'index.php?admin/attendance_update_instructor/' . $timestamp); ?>
        <div id="attendance_update_instructor">
...
//                    $sql = "SELECT * FROM instructor WHERE tstatus = 'active'";
//                    $attendance_of_instructors = $this->db->query($sql)->result_array();
                    foreach ($attendance_of_instructors as $row):
                        ?>
                        <tr>
                            <td><?php echo $count++; ?></td>
                            <td>
                                <?php echo $this->db->get_where('instructor', array('instructor_id' => $row['instructor_id']))->row()->card_no; ?>
                            </td>
                            <td>
                                <?php echo $this->db->get_where('instructor', array('instructor_id' => $row['instructor_id']))->row()->name; ?>
                            </td>
                            <td>
...
<script type="text/javascript">
    ...
    function mark_all_present() {
        var count = <?php echo count($attendance_of_instructors); ?>;
