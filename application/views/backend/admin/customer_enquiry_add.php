	...
	<div class="col-md-8">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/customer_enquiry/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" data-message-required="<?php echo get_phrase('value_required');?>" name="phone" value="" >
						</div> 
					</div>
                    
                    <div class="form-group">
                    	<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('whatsapp');?>
						</label>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="extimate_date_completion" value="" data-start-view="2"  autocomplete="off">
						</div> 
					</div>

					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('follow_up_on');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="follow_up_on" data-message-required="<?php echo get_phrase('value_required');?>" value="" data-start-view="2"  autocomplete="off">
						</div> 
					</div>
