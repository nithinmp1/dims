      ...
      <div class="tab-content">
          ...
          <table class="table table-bordered datatable" id="table_export">
            <thead>
              <tr>
                ...
                <tbody>
                <?php 
                $customerServ = $this->db->order_by('service_list_id','desc')->get_where('customer_service_list',['student_id' => $student_id])->result_array();
        ...
        <div class="tab-pane box" id="add_service" style="padding: 5px">
          <div class="box-content"> 
            <?php
            echo form_open(base_url() . 'index.php?admin/customer_service_list/student_create' , 
            array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'),
            ['student_id' => $student_id,'status' => 'Pending']);?> <div class="padded">
