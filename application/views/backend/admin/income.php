            ...
            <div class="tab-pane <?php if ($active_tab == 'invoices') echo 'active'; ?>" id="unpaid">
                <table class="table table-bordered datatable example">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><div><?php echo get_phrase('student/Customer'); ?></div></th>
                    ...
                    <tbody>
                        ...
                        foreach ($invoices as $row):
                            ...
                            <tr>
                                ...
                                <td><?php 
                                if (isset($row['customer_id']) && ($row['customer_id'] !==0 && $row['customer_id'] !== '' )) {
                                    $customer = $this->db->get_where('customer',['customer_id' => $row['customer_id']])->row();
                                    echo $customer->name;
                                } else {
                                ...
                                <?php endif; ?>
                                <td><?php echo $row['creation_timestamp']; // date('d M,Y', $row['creation_timestamp']); ?></td>
                                <td>
                                    <div class="btn-group">
                    ...
                    <tbody>
                        ...
                        foreach ($payments as $row):
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $payment_mode = $this->db->get_where('payment_mode',['payment_mode_id' => $row['method']])->row();
                                ...
                                <td align="center">
                                    <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_view_payment/<?php echo $row['payment_id']; ?>');"
