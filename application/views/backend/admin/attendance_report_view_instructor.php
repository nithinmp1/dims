...
<?php echo form_open(base_url() . 'index.php?admin/attendance_report_instructor_selector'); ?>
<div class="row">
    <div class="col-md-2">
                ...
                <thead>
                    <tr>
                        <td style="text-align: center;">
                            <?php echo get_phrase('instructors'); ?> <i class="entypo-down-thin"></i> | <?php echo get_phrase('date'); ?> <i class="entypo-right-thin"></i>
                        </td>
                        <?php
...
//                    print_r($my);
//                    exit;
                    $instructors = $this->db->get_where('instructor_attendance', array('month_year' => $sd))->result_array();
                    foreach ($instructors as $row):
                        ...
                        <tr>
                            ...
                            for ($i = 1; $i <= $days; $i++) {
                                ...
                                $attendance = $this->db->get_where('instructor_attendance', array('year' => $running_year, 'timestamp' => $timestamp, 'instructor_id' => $row['instructor_id']))->result_array();
            ...
            <center>
                <a href="<?php echo base_url(); ?>index.php?admin/attendance_report_print_view_instructor/<?php echo $month; ?>/<?php echo $sessional_year; ?>" 
